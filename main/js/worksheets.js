...
export function fn_worksheets() {
	...
	for (let i=0; i<all.length; i++) {
		states.push(all[i].state);
		abbreviation.push(all[i].abbreviation);
		capital.push(all[i].capital);
	}
