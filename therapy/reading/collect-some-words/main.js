...
function fn_set_words() {
	...
	let text = `[
    {
        ...
        "text": [
            "I think I ran over a buck.",
            "Karen was in the wrong lane.",
            "The plumber had to pour out all of the old chemicals.",
            "The elf passed out all of the presents.",
            "The cafeteria worker couldn't get the last tray.",
            "She posted a new website.",
            "The weatherman thought it was going to be a sunny day, but instead, there was a big storm.",
            "The engineer was not a citizen.",
            "He was the father of the children.",
            "Somebody robbed the bank.",
            "The vampire was ready to get back in his casket.",
            "The consultant looked up the finances to make sure they were mutual dealings.",
            "The tourist has the option of getting on the boat.",
            "Kevin thought it was weird that everyone else was partying hard.",
            "Teresa was on a pleasure cruise to see the Caribbean."
        ]
    }
]`;

	let a = JSON.parse(text);
	localStorage.setItem(local_storage, JSON.stringify(a));
}
